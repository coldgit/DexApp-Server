        ...
        +'<table class="table table-responsive">'
            ...
            +'<tbody>'
                +'<tr ng-repeat="x in reginfo.slice(((currentPage-1)*10), ((currentPage)*10)) | filter:data">'
                    ...
                    +'<td>{{x.email}}</td>'
                    +'<td>{{x.role}}</td>'
                    +'<td class="btn-group"><button type="button" ng-click="deleteUser(x.username)" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-trash"></i></button><button type="button" ng-click="getUser(x.username)" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></button></td>'
                    +'<td>{{x.acc_created}}</td>'
                        ...
                        +'<table class="table table-reponsive">'
                            ...
                            +'<tbody>'
                                +'<tr ng-repeat="x in animes.slice(((currentPage-1)*10), ((currentPage)*10))">'
                                    +'<td>{{x.ani_title}}</td>'
                                    +'<td>{{x.date_time}}</td>'
                                    +'<td class="btn-group"><button type="button" ng-click="delete_anime(x.ani_title)" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-trash"></i></button><button type="button" ng-click="select_anime(x.ani_url)" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></button></td>'
                                    +'</tr>'
                            +'</tbody>'
                        +'</table>'
                    +'<div >'     
                    ...
                    +'<table class="table table-reponsive">'
                        ...
                        +'<tbody>'
                            +'<tr ng-repeat="x in episodes.slice(((currentPage-1)*10), ((currentPage)*10))">'
                                +'<td>{{x.episode}}</td>'
                                +'<td>{{x.date_time}}</td>'
                                 +'<td class="btn-group"><button type="button" ng-click="delete_episode(title.ani_title,x.episode)" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-trash"></i></button><button type="button" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></button></td>'
                                +'</tr>'
                        +'</tbody>'
                    +'</table>'
                    +'<div>'            
